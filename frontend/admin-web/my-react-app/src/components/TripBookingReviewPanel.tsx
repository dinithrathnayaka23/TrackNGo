...
export default function TripBookingReviewPanel({ bookings, onUpdated }: Props) {
  ...
  return <section className="rounded-xl border border-[#dbe3f0] bg-white p-5 shadow-sm">
