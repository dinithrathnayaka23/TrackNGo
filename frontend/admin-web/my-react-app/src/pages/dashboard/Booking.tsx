...
function Booking() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4"><Stat label="Total Bookings" value={bookings.length} icon={faBus} color="text-[#334155]" bg="bg-[#f1f5f9]" /><Stat label="Confirmed" value={stats.confirmed} icon={faCheckCircle} color="text-[#16a34a]" bg="bg-[#dcfce7]" /><Stat label="Pending" value={stats.pending} icon={faHourglassHalf} color="text-[#f59e0b]" bg="bg-[#fef3c7]" /><Stat label="Cancelled" value={stats.cancelled} icon={faTimesCircle} color="text-[#dc2626]" bg="bg-[#fee2e2]" /></div>
