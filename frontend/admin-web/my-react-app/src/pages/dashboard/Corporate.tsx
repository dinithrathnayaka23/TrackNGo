...
import { faArrowLeft, faBuildingUser, faChevronDown, faChevronLeft, faChevronRight, faClipboardCheck, faComments, faFileLines, faMagnifyingGlass, faMoneyBillWave, faSpinner } from '@fortawesome/free-solid-svg-icons'
...
function Corporate() {
  ...
  const openCorporateChat = (client: CorporateClient) => {
    const path = getAdminChatPath(client.id, 'Corporate')
