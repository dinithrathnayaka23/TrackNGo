...
const DriverManagement = () => {
  ...
  return (
    <>
      <div className="p-6 bg-[#F5F7FA] min-h-screen min-w-[75vw]">

        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          <div>
            <FaArrowLeft className="text-black mb-1" />
        ...
        {/* Main Card */}
        <div className="bg-white rounded-xl shadow-sm p-5 text-black">
          ...
          <div className="flex flex-wrap items-center gap-8 mt-5">
            ...
            <select
              ...
              className="w-[240px] px-3 py-2 border rounded-lg text-sm"
            >
                ...
                {filteredDrivers.map((d) => (
                  <tr key={d.id} className="border-t">
                    <td className="p-4 flex items-center">
                      <FaUserLarge className="text-blue-600 mr-2" />
                      <div>
      ...
      {showAddDriver && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg w-[400px] flex flex-col">
            ...
            {[
              ...
              <input
                key={p}
                placeholder={p}
                className="px-3 py-2 mb-2 border rounded text-sm bg-gray-50"
              />
            ))}
