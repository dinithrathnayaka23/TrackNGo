...
import { resendLoginOtp, verifyLoginOtp } from '@/services/twoFactorApi';

const OTP_LENGTH = 6;
// Must match AuthServiceImpl.LOGIN_OTP_RESEND_COOLDOWN_SECONDS on the backend.
const RESEND_SECONDS = 30;

export default function DriverTwoFactorVerificationScreen() {
  ...
  const handleVerify = async () => {
    ...
    setIsLoading(true);
    try {
      const result = await verifyLoginOtp(challengeToken, code);
    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.iconCircle}>
          <Ionicons name="shield-checkmark" size={36} color="#2F6BFF" />
        </View>
