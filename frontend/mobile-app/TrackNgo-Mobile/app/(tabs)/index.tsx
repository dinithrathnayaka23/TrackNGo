...
const quickActions = [
  {
    key: 'highway',
    label: 'Highway Bus',
    icon: (color: string) => <MaterialCommunityIcons name="road-variant" size={20} color={color} />,
  },
  {
    key: 'long-distance',
    label: 'Long Distance',
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <Animated.View
          ...
          <View style={styles.headerActions}>
            <PressScale onPress={() => Alert.alert('Notifications', 'No new notifications yet.')}
              >
            ...
            <View key={booking.id} style={[styles.bookingCard, { backgroundColor: booking.base }]}>
              ...
              <View style={styles.cardBottomRow}>
                ...
                <View style={styles.cardActions}>
                  ...
                  <PressScale
                    onPress={() => Alert.alert('Ticket', `Viewing ticket #${booking.id}.`)}>
                    <View style={styles.smallButton}>
                      <Text style={[styles.smallButtonText, { color: booking.base }]}>View Ticket</Text>
                    </View>
                  </PressScale>
                </View>
              </View>
