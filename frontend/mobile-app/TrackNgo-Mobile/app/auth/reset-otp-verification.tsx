...
import { resendPasswordResetOtp, verifyPasswordResetOtp } from "../../services/passwordResetApi";
    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === "ios" ? "padding" : "height"}>
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.85}
        >
          {loading ? <ActivityIndicator color="#FFFFFF" size="small" /> : <Text style={styles.verifyBtnText}>Verify</Text>}
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
  );
