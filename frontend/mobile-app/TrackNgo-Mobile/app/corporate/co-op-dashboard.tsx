...
export default function CoOpDashboardScreen() {
  ...
  const loadData = useCallback(
    async (isRefresh = false) => {
      ...
      try {
        const [profileData, contractData, invoiceData] = await Promise.all([
    ...
    <SafeAreaView style={styles.flex}>
      ...
      >
        ...
        <View style={styles.gradientCard}>
          ...
          <Text style={styles.cardTitle}>Create New Contract</Text>
          <Text style={styles.cardSubtitle}>
            Set up your corporate contract. Start by creating your first
            transportation contract for your employees.
          </Text>
          <TouchableOpacity
            style={styles.getStartedBtn}
            onPress={() => router.push("/corporate/new-contract")}
          >
            <Text style={styles.getStartedBtnText}>Get Started Now</Text>
            <Ionicons
              name="arrow-forward"
              size={16}
              color="#067BF9"
        ...
        {!loading && activeContracts.length > 0 && (
          <View style={styles.overviewSection}>
            ...
            {activeContracts.slice(0, 2).map((contract) => (
              <View key={contract.contractId} style={styles.contractPreviewCard}>
                <Ionicons
      ...
      <View style={styles.tabBar}>
        ...
        >
          <Ionicons name="grid" size={22} color="#067BF9" />
...
const styles = StyleSheet.create({
  ...
  spendLabelRow: { flexDirection: "row", alignItems: "center" },
  spendLabel: { fontSize: 13, fontWeight: "600", color: "#64748B", marginLeft: 8 },
  spendValue: { fontSize: 18, fontWeight: "700", color: "#1E293B" },
  ...
  tabLabel: { fontSize: 11, fontWeight: "600", color: "#64748B", marginTop: 4 },
