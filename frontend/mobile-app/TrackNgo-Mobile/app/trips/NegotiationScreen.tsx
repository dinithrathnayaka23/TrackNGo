...
export default function NegotiationScreen() {
  ...
  const approved = status === "confirmed" && Boolean(trip.negotiatedAt);
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#F8FAFC" }, content: { paddingBottom: 40 }, header: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 20, backgroundColor: "white" }, headerTitle: { fontSize: 16, fontWeight: "bold", color: "#1E293B" }, ticketHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 20, paddingVertical: 15, backgroundColor: "#1E293B" }, bookingIdLabel: { color: "#94A3B8", fontSize: 10, fontWeight: "bold" }, bookingIdValue: { color: "#22C55E", fontSize: 18, fontWeight: "bold" }, statusBadge: { flexDirection: "row", alignItems: "center", paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 }, statusBadgePending: { backgroundColor: "rgba(96,165,250,.1)" }, statusBadgeConfirmed: { backgroundColor: "rgba(34,197,94,.1)" }, statusBadgeRejected: { backgroundColor: "rgba(239,68,68,.1)" }, statusText: { fontSize: 11, fontWeight: "bold", marginLeft: 6 }, liveDot: { width: 6, height: 6, borderRadius: 3 }, routeCard: { backgroundColor: "white", margin: 20, padding: 20, borderRadius: 15, elevation: 2 }, routePoint: { flexDirection: "row", alignItems: "center" }, routeName: { marginLeft: 10, fontSize: 16, fontWeight: "600", color: "#1E293B", flexShrink: 1 }, routeLine: { width: 2, height: 20, backgroundColor: "#E2E8F0", marginLeft: 8, marginVertical: 4 }, tripMeta: { flexDirection: "row", justifyContent: "space-between", marginTop: 15, paddingTop: 15, borderTopWidth: 1, borderTopColor: "#F1F5F9" }, metaText: { fontSize: 12, color: "#64748B" }, sectionTitle: { paddingHorizontal: 20, marginBottom: 10, marginTop: 4, fontSize: 14, fontWeight: "bold", color: "#64748B", textTransform: "uppercase" }, busCard: { flexDirection: "row", backgroundColor: "white", marginHorizontal: 20, padding: 15, borderRadius: 15, alignItems: "center" }, busImage: { width: 80, height: 60, borderRadius: 10, backgroundColor: "#F1F5F9" }, busInfo: { marginLeft: 15, flex: 1 }, busNumber: { fontSize: 16, fontWeight: "bold", color: "#1E293B" }, busBrand: { fontSize: 13, color: "#64748B" }, requirementText: { color: "#2563EB", fontSize: 11, marginTop: 6 }, priceCard: { backgroundColor: "white", marginHorizontal: 20, padding: 20, borderRadius: 15 }, estimateBanner: { flexDirection: "row", gap: 10, backgroundColor: "#EFF6FF", padding: 12, borderRadius: 12, marginBottom: 14 }, estimateText: { flex: 1, color: "#1D4ED8", fontSize: 12, lineHeight: 18 }, finalBanner: { flexDirection: "row", gap: 10, backgroundColor: "#F0FDF4", padding: 12, borderRadius: 12, marginBottom: 14 }, finalText: { flex: 1, color: "#166534", fontSize: 12, lineHeight: 18 }, priceRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginVertical: 5, gap: 12 }, priceLabel: { flex: 1, color: "#64748B", fontSize: 14 }, priceValue: { fontSize: 20, fontWeight: "bold", color: "#1E293B" }, divider: { height: 1, backgroundColor: "#F1F5F9", marginVertical: 10 }, advanceLabel: { flex: 1, color: "#16A34A", fontWeight: "600", fontSize: 13 }, advanceValue: { color: "#16A34A", fontWeight: "bold", fontSize: 16 }, dueLabel: { flex: 1, color: "#64748B", fontSize: 13 }, dueValue: { color: "#1E293B", fontWeight: "bold", fontSize: 16 }, discountLabel: { flex: 1, color: "#16A34A", fontSize: 13 }, discountValue: { color: "#16A34A", fontWeight: "bold", fontSize: 15 }, priceNote: { fontSize: 11, color: "#64748B", lineHeight: 17, marginTop: 12 }, rejectedBox: { flexDirection: "row", gap: 10, alignItems: "flex-start", backgroundColor: "#FEF2F2", padding: 12, borderRadius: 12 }, rejectedText: { flex: 1, color: "#B91C1C", fontSize: 13, lineHeight: 19 }, actions: { padding: 20 }, negotiateTitle: { fontSize: 15, fontWeight: "700", color: "#1E293B" }, negotiateText: { color: "#64748B", fontSize: 12, marginTop: 4, marginBottom: 14 }, buttonRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 15 }, secondaryBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: "white", borderWidth: 1, borderColor: "#E2E8F0", paddingVertical: 12, borderRadius: 12, width: "48%" }, secondaryBtnText: { marginLeft: 8, color: "#1E293B", fontWeight: "600" }, primaryBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", backgroundColor: "#2563EB", paddingVertical: 16, borderRadius: 12, elevation: 5 }, primaryBtnText: { color: "white", fontWeight: "bold", fontSize: 15, marginRight: 10 }, disabledBtn: { backgroundColor: "#E2E8F0", elevation: 0 }, disabledText: { color: "#64748B" }, homeButton: { alignItems: "center", paddingVertical: 14, marginTop: 10 }, homeText: { color: "#64748B", fontWeight: "600" },
});
