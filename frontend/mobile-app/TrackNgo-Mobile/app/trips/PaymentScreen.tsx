...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontSize: 24, fontWeight: "800", color: "#111827", textAlign: "center", marginHorizontal: 8 },
  ...
  amount: { color: "#2563EB", fontSize: 28, fontWeight: "800", marginVertical: 8, textAlign: "center" },
  ...
  payText: { flexShrink: 1, color: "white", fontWeight: "700", fontSize: 16, textAlign: "center" },
