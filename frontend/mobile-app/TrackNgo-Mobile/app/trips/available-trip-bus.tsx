...
const styles = StyleSheet.create({
  ...
  busNumber: { fontSize: 16, fontWeight: "700", color: "#1E293B" },
  ...
  amenityText: { fontSize: 10, fontWeight: "700", color: "#475569" },
  center: { flex: 1, alignItems: "center", justifyContent: "center", padding: 40 },
  loadingText: { marginTop: 15, color: "#64748B", fontSize: 13, fontWeight: "500"},
  emptyText: { marginTop: 20, textAlign: "center", color: "#64748B", fontSize: 14, fontWeight: "600" },
